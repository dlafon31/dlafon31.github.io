    ...
    <div style={{ padding: '2px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          {selectedMonth && selectedYear && (
            <div style={{
              ...
              Période sélectionnée : {getMonthName(selectedMonth)} {selectedYear}
            </div>
          )}
        </div>
      </div>
      ...
      {selectedMonth && selectedYear && (
        <div style={{
          ...
          <h2 style={{ margin: '0 0 20px 0', color: '#1f2937', fontSize: '20px' }}>
            📊 Statistiques du mois - {getMonthName(selectedMonth)} {selectedYear}
          </h2>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: '28px', color: '#3b82f6', fontWeight: 'bold', marginBottom: '8px' }}>
                {statistics.totalPrevues}
              </div>
              <div style={{ color: '#64748b', fontWeight: '500' }}>Astreintes prévues</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '28px', color: '#10b981', fontWeight: 'bold', marginBottom: '8px' }}>
                {statistics.totalValidees}
              </div>
              <div style={{ color: '#16a34a', fontWeight: '500' }}>Astreintes validées</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '28px', color: '#eab308', fontWeight: 'bold', marginBottom: '8px' }}>
                {statistics.totalEligibles}
              </div>
              <div style={{ color: '#ca8a04', fontWeight: '500' }}>Éligibles à un paiement</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '28px', color: '#0284c7', fontWeight: 'bold', marginBottom: '8px' }}>
                {statistics.totalPayees}
              </div>
              <div style={{ color: '#0369a1', fontWeight: '500' }}>Déjà mises en paiement</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '28px', color: '#dc2626', fontWeight: 'bold', marginBottom: '8px' }}>
                {statistics.aPayerEtat}
              </div>
              <div style={{ color: '#b91c1c', fontWeight: '500' }}>À payer sur budget ÉTAT</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '28px', color: '#9333ea', fontWeight: 'bold', marginBottom: '8px' }}>
                {statistics.aPayerEnvt}
              </div>
              <div style={{ color: '#7c3aed', fontWeight: '500' }}>À payer sur budget ENVT</div>
            </div>
          </div>
        </div>
      )}
            ...
            <div>
              ...
              {formData.budget && (
                <div style={{
                  ...
                  {getAstreintesToPay().length} astreinte{getAstreintesToPay().length > 1 ? 's' : ''} à payer sur ce budget
                </div>
              )}
            </div>
      ...
      {!isResponsable() && selectedMonth && selectedYear && (
        <div style={{
          ...
          <div style={{ color: '#92400e', fontSize: '16px', fontWeight: '500' }}>
